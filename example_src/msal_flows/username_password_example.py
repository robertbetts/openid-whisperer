"""
Source from https://github.com/AzureAD/microsoft-authentication-library-for-python/blob/dev/sample/username_password_sample.py
...
config.update({
    ...
    "endpoint": "https://bbb-mbp.local:9443/mock-api/",
})
